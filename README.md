![MyGate Crypto Payment Gateway](assets/images/features.png)

# MyGate Crypto Payment Gateway
Contributors: mygate
Tags: woocommerce, easy digital downloads, cryptocurrency, bitcoin, monero
...
Accept Bitcoin, USDT, Monero and more in WooCommerce and Easy Digital Downloads with the MyGate crypto payment gateway.

## Description

### 🚀 Crypto payments for WooCommerce & Easy Digital Downloads
...
[🪙 Browse all supported cryptocurrencies and networks](https://mygate.me/currencies/)
...
* ⚡ **Automatic payment confirmation** — orders are updated after the cryptocurrency payment is verified.
* 🔐 **Private API keys stay private** — the `sk_live_` key remains on your WordPress server.
...
1. Your customer chooses **MyGate** at WooCommerce or Easy Digital Downloads checkout.
2. MyGate opens a cryptocurrency payment screen.
3. The customer selects a cryptocurrency and sends the payment.
4. MyGate verifies the blockchain transaction.
5. Your WooCommerce order or EDD payment is automatically confirmed.
6. The customer returns to the completed order or payment page.
...
[See the current list of supported cryptocurrencies and networks](https://mygate.me/currencies/)
